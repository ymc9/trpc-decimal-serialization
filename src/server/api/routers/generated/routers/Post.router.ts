...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    aggregate: {
        useQuery: <T extends Prisma.PostAggregateArgs>(
            ...
            opts?: UseTRPCQueryOptions<
                ...
                Error
            >,
        ) => UseTRPCQueryResult<Prisma.GetPostAggregateType<T>, TRPCClientErrorLike<AppRouter>>;
    ...
    findFirst: {
        useQuery: <T extends Prisma.PostFindFirstArgs>(
            ...
            opts?: UseTRPCQueryOptions<string, T, Prisma.PostGetPayload<T>, Prisma.PostGetPayload<T>, Error>,
        ) => UseTRPCQueryResult<Prisma.PostGetPayload<T>, TRPCClientErrorLike<AppRouter>>;
    ...
    findMany: {
        useQuery: <T extends Prisma.PostFindManyArgs>(
            ...
            opts?: UseTRPCQueryOptions<
                ...
                Error
            >,
        ) => UseTRPCQueryResult<Array<Prisma.PostGetPayload<T>>, TRPCClientErrorLike<AppRouter>>;
